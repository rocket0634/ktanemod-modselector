...
{
    public ProfileSettingsPage settingsPage = null;
    ...
    private void Awake()
    {
        ...
        for (int optionIndex = 0; optionIndex < _options.Length; ++optionIndex)
        {
            ...
            {
                settingsPage.profile = _availableProfiles[OptionOffset + localOptionIndex];
                return true;
            };
        }
    }
    ...
    public void SetPage(int pageIndex)
    {
        ...
        _tabletPage.header.text = string.Format("<b>Select Profile</b>\n<size=16>Page {0} of {1}</size>", _pageIndex + 1, TotalPageCount);
    }
